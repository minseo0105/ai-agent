...
| 88컨트리클럽 | 36 | 확인필요 | 4 | 0 |
| 라비에벨CC | 36 | 확인필요 | 1 | 0 |
| 레이크사이드CC | 54 | 확인필요 | 2 | 9 |
| 레인보우힐스CC | 확인필요 | 확인필요 | 4 | 0 |
| 블랙스톤 이천 | 27 | 확인필요 | 4 | 0 |
| 블루헤런GC | 18 | 확인필요 | 5 | 0 |
| 사우스스프링스CC | 확인필요 | 확인필요 | 2 | 0 |
...
- **name**: "88컨트리클럽" — 출처 검토 근거 있음; 사용자 최종 검토 전 (출처일 미상, 확인일 2026-09-20)
...
- **booking_url**: "https://88countryclub.co.kr/Reservation/Reservation.aspx" — 출처 검토 근거 있음; 사용자 최종 검토 전 (출처일 미상, 확인일 2026-09-20)
- **external_booking_url**: null — 필드별 근거 없음 (출처일 미상, 확인일 없음)
- **description**: "국가유공자 복지 재원인 보훈기금 증식을 목적으로 설립된 골프장." — 출처 검토 근거 있음; 사용자 최종 검토 전 (출처일 미상, 확인일 2026-09-20)
...
- 변경 후보 `booking_url`: null → "https://88countryclub.co.kr/Reservation/Reservation.aspx"
- 변경 후보 `description`: "동·서코스 총 36홀. 공식 홀 공략에서 일부 홀의 페어웨이 폭이 넓다고 안내하는 전략적 코스." → "국가유공자 복지 재원인 보훈기금 증식을 목적으로 설립된 골프장."
...
- **name**: "레이크사이드" — 출처 검토 근거 있음; 사용자 최종 검토 전 (출처일 미상, 확인일 2026-09-20)
...
- **booking_url**: "https://www.rainbowhills.co.kr/pagesite/reservation/live.asp" — 출처 검토 근거 있음; 사용자 최종 검토 전 (출처일 미상, 확인일 2026-09-20)
- **external_booking_url**: null — 필드별 근거 없음 (출처일 미상, 확인일 없음)
- **description**: null — 필드별 근거 없음 (출처일 미상, 확인일 없음)
...
- 변경 후보 `name`: "레인보우힐스CC" → "레인보우힐스컨트리클럽"
...
- 변경 후보 `booking_url`: null → "https://www.rainbowhills.co.kr/pagesite/reservation/live.asp"
- KGA 구조 유효 15행 / 격리 0행. PDF 원문 재검증 전.

## 블랙스톤 이천

- **name**: "블랙스톤 이천" — 출처 검토 근거 있음; 사용자 최종 검토 전 (출처일 미상, 확인일 2026-09-20)
...
- **booking_url**: null — 필드별 근거 없음 (출처일 미상, 확인일 없음)
- **external_booking_url**: null — 필드별 근거 없음 (출처일 미상, 확인일 없음)
- **description**: "동·북·서 코스로 구성된 총 27홀 골프장." — 출처 검토 근거 있음; 사용자 최종 검토 전 (출처일 미상, 확인일 2026-09-20)
...
- 변경 후보 `description`: "27홀 규모. 상세 코스 구성은 공식 홈페이지에서 확인할 수 있습니다." → "동·북·서 코스로 구성된 총 27홀 골프장."
- 보류 `operation_type`: 현재 운영형태의 최근 작성일·효력일 확인 필요
- KGA 구조 유효 15행 / 격리 0행. PDF 원문 재검증 전.

## 블루헤런GC

- **name**: "블루헤런" — 출처 검토 근거 있음; 사용자 최종 검토 전 (출처일 미상, 확인일 2026-09-20)
...
- **booking_url**: "https://blueheron.co.kr/reservation/golf" — 출처 검토 근거 있음; 사용자 최종 검토 전 (출처일 미상, 확인일 2026-09-20)
- **external_booking_url**: null — 필드별 근거 없음 (출처일 미상, 확인일 없음)
- **description**: "West와 East 두 코스를 갖춘 총18홀 골프장." — 출처 검토 근거 있음; 사용자 최종 검토 전 (출처일 미상, 확인일 2026-09-20)
...
- 변경 후보 `booking_url`: null → "https://blueheron.co.kr/reservation/golf"
- 변경 후보 `description`: "WEST 9H + EAST 9H, 총 18홀. 공식 코스 제원 기준 총 Par 72 · 7,043yd. 페어웨이 중지, 그린 벤트그라스." → "West와 East 두 코스를 갖춘 총18홀 골프장."
- KGA 구조 유효 0행 / 격리 0행. PDF 원문 재검증 전.

## 사우스스프링스CC

- **name**: "사우스스프링스" — 출처 검토 근거 있음; 사용자 최종 검토 전 (출처일 미상, 확인일 2026-09-20)
...
- 청주 예약 링크를 열었으나 본문은 강촌 안내이고 강촌 외 다른 지점 예약 미지원이라고 표시. 지점 identity 검토 전 공식 예약URL로 채택하지 않음. 검토 URL: https://www.serenitygolfresort.com/booking/?destination=cheongju
...
- **name**: "클럽디 더플레이어스" — 출처 검토 근거 있음; 사용자 최종 검토 전 (출처일 미상, 확인일 2026-09-20)
...
기존 실행의 실제 HTTP 확인 기록 재사용: `data/golf/enrichment/builder2/20260920_200239_410536/result.json`
...
- 백업: `data/golf/backups/catalog_before_builder2_20260920_200800_891818.json`
- catalog 반영 코드, NAVER 호출, 외부 LLM 호출 없음.

## 테스트

Builder 2 전용 17개 테스트 통과, 새 Python 3개 파일 문법 검사 통과. 기존 전체 골프 테스트는 5 failures / 3 errors: golf_api 모듈 누락 2건, naver_calls 키 누락 1건, 기존 최신성/Pool/UI 기대값 불일치 5건. 기존 파일 변경 없이 확인한 결과이며 이번 작업에서 해당 코드는 수정하지 않음.
